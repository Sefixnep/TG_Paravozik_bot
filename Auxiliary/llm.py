...
class LLMModel:
    ...
    def generate_prompt(self, question):
        ...
        prompt = (
            ...
            f"Если вопрос является неуместным, оскорбительным или бессмысленным в контексте вашей роли как помощника по вопросам социального пакета и льгот сотрудников ОАО 'РЖД', "
