...
- LearningResources.pdf - ВАЖНЫЙ ФАЙЛ, который должен содержать нормативный документ, разбитый на пункты. (НАЗВАНИЕ ПРИ ЗАМЕНЕ ФАЙЛА НЕОБХОДИМО ПОМЕНЯТЬ НА "LearningResources.pdf")
